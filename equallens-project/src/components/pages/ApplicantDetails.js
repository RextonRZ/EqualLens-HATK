                                ...
                                { key: 'courseworkResearch', title: 'Relevant Coursework' }
                                    ...
                                    return (
                                        <div key={item.key} className="score-card compact-card">
                                            ...
                                            <div className="education-progress-bar-container">
                                                <div
                                                    className="progress-bar"
                                                    style={{
                                                        width: `${score * 10}%`,
                                ...
                                { key: 'communityEngagement', title: 'Community Engagement' }
                                    ...
                                    return (
                                        <div key={item.key} className="score-card compact-card">
                                            ...
                                            <div className="cultural-fit-progress-bar-container">
                                                <div
                                                    className="progress-bar"
                                                    style={{
                                                        width: `${score * 10}%`,
                                    ...
                                    {(!job?.prompt || job?.prompt === "") ? (
                                        <div className="breakdown-columns four-columns">
                                            <div className="breakdown-column">
                                                <div className="score-card"><h4>Relevance to Job</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#8250c8' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Proficiency Level</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#8250c8' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Additional Skills</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#8250c8' }}></div></div><p>N/A</p></div>
                                            </div>
                                            <div className="breakdown-column">
                                                <div className="score-card"><h4>Job Experience</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#dd20c1' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Projects & Co-curricular</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#dd20c1' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Certifications</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#dd20c1' }}></div></div><p>N/A</p></div>
                                            </div>
                                            <div className="breakdown-column">
                                                <div className="score-card"><h4>Level of Study</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#0066cc' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Awards & Achievements</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#0066cc' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Relevant Coursework</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#0066cc' }}></div></div><p>N/A</p></div>
                                            </div>
                                            <div className="breakdown-column">
                                                <div className="score-card"><h4>Collaboration Style</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#ffa000' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Growth Mindset</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#ffa000' }}></div></div><p>N/A</p></div>
                                                <div className="score-card"><h4>Community Engagement</h4><div className="progress-bar-container"><div className="progress-bar unranked" style={{ width: '100%', backgroundColor: '#ffa000' }}></div></div><p>N/A</p></div>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className={`breakdown-columns ${[job?.prompt?.includes("Skills"), job?.prompt?.includes("Experience"), job?.prompt?.includes("Education"), job?.prompt?.includes("Cultural Fit")].filter(Boolean).length === 1 ? "single-column" : [job?.prompt?.includes("Skills"), job?.prompt?.includes("Experience"), job?.prompt?.includes("Education"), job?.prompt?.includes("Cultural Fit")].filter(Boolean).length === 2 ? "two-columns" : [job?.prompt?.includes("Skills"), job?.prompt?.includes("Experience"), job?.prompt?.includes("Education"), job?.prompt?.includes("Cultural Fit")].filter(Boolean).length === 3 ? "three-columns" : "four-columns"}`}>
                                            {job?.prompt?.includes("Skills") && (
                                                <div className="breakdown-column">
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Relevance to Job", applicant.rank_score?.relevance || 0, applicant.reasoning?.relevance, "#8250c8")}><h4>Relevance to Job</h4><div className="skills-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Skills") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Skills") ? '100%' : `${applicant.rank_score?.relevance ? (applicant.rank_score.relevance * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Skills") ? '#d9d9d9' : '#8250c8' }}></div></div><p>{!job?.prompt?.includes("Skills") ? "Unranked" : (applicant.rank_score?.relevance ? `${applicant.rank_score.relevance}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Proficiency Level", applicant.rank_score?.proficiency || 0, applicant.reasoning?.proficiency, "#8250c8")}><h4>Proficiency Level</h4><div className="skills-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Skills") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Skills") ? '100%' : `${applicant.rank_score?.proficiency ? (applicant.rank_score.proficiency * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Skills") ? '#d9d9d9' : '#8250c8' }}></div></div><p>{!job?.prompt?.includes("Skills") ? "Unranked" : (applicant.rank_score?.proficiency ? `${applicant.rank_score.proficiency}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Additional Skills", applicant.rank_score?.additionalSkill || 0, applicant.reasoning?.additionalSkill, "#8250c8")}><h4>Additional Skills</h4><div className="skills-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Skills") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Skills") ? '100%' : `${applicant.rank_score?.additionalSkill ? (applicant.rank_score.additionalSkill * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Skills") ? '#d9d9d9' : '#8250c8' }}></div></div><p>{!job?.prompt?.includes("Skills") ? "Unranked" : (applicant.rank_score?.additionalSkill ? `${applicant.rank_score.additionalSkill}/10` : "0/10")}</p></div>
                                                </div>
                                            )}
                                            {job?.prompt?.includes("Experience") && (
                                                <div className="breakdown-column">
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Job Experience", applicant.rank_score?.jobExp || 0, applicant.reasoning?.jobExp, "#dd20c1")}><h4>Job Experience</h4><div className="experience-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Experience") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Experience") ? '100%' : `${applicant.rank_score?.jobExp ? (applicant.rank_score.jobExp * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Experience") ? '#d9d9d9' : '#dd20c1' }}></div></div><p>{!job?.prompt?.includes("Experience") ? "Unranked" : (applicant.rank_score?.jobExp ? `${applicant.rank_score.jobExp}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Projects & Co-curricular", applicant.rank_score?.projectCocurricularExp || 0, applicant.reasoning?.projectCocurricularExp, "#dd20c1")}><h4>Projects & Co-curricular</h4><div className="experience-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Experience") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Experience") ? '100%' : `${applicant.rank_score?.projectCocurricularExp ? (applicant.rank_score.projectCocurricularExp * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Experience") ? '#d9d9d9' : '#dd20c1' }}></div></div><p>{!job?.prompt?.includes("Experience") ? "Unranked" : (applicant.rank_score?.projectCocurricularExp ? `${applicant.rank_score.projectCocurricularExp}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Certifications", applicant.rank_score?.certification || 0, applicant.reasoning?.certification, "#dd20c1")}><h4>Certifications</h4><div className="experience-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Experience") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Experience") ? '100%' : `${applicant.rank_score?.certification ? (applicant.rank_score.certification * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Experience") ? '#d9d9d9' : '#dd20c1' }}></div></div><p>{!job?.prompt?.includes("Experience") ? "Unranked" : (applicant.rank_score?.certification ? `${applicant.rank_score.certification}/10` : "0/10")}</p></div>
                                                </div>
                                            )}
                                            {job?.prompt?.includes("Education") && (
                                                <div className="breakdown-column">
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Level of Study", applicant.rank_score?.studyLevel || 0, applicant.reasoning?.studyLevel, "#0066cc")}><h4>Level of Study</h4><div className="education-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Education") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Education") ? '100%' : `${applicant.rank_score?.studyLevel ? (applicant.rank_score.studyLevel * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Education") ? '#d9d9d9' : '#0066cc' }}></div></div><p>{!job?.prompt?.includes("Education") ? "Unranked" : (applicant.rank_score?.studyLevel ? `${applicant.rank_score.studyLevel}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Awards & Achievements", applicant.rank_score?.awards || 0, applicant.reasoning?.awards, "#0066cc")}><h4>Awards & Achievements</h4><div className="education-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Education") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Education") ? '100%' : `${applicant.rank_score?.awards ? (applicant.rank_score.awards * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Education") ? '#d9d9d9' : '#0066cc' }}></div></div><p>{!job?.prompt?.includes("Education") ? "Unranked" : (applicant.rank_score?.awards ? `${applicant.rank_score.awards}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Relevant Coursework", applicant.rank_score?.courseworkResearch || 0, applicant.reasoning?.courseworkResearch, "#0066cc")}><h4>Relevant Coursework</h4><div className="education-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Education") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Education") ? '100%' : `${applicant.rank_score?.courseworkResearch ? (applicant.rank_score.courseworkResearch * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Education") ? '#d9d9d9' : '#0066cc' }}></div></div><p>{!job?.prompt?.includes("Education") ? "Unranked" : (applicant.rank_score?.courseworkResearch ? `${applicant.rank_score.courseworkResearch}/10` : "0/10")}</p></div>
                                                </div>
                                            )}
                                            {job?.prompt?.includes("Cultural Fit") && (
                                                <div className="breakdown-column">
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Collaboration Style", applicant.rank_score?.collaborationStyle || 0, applicant.reasoning?.collaborationStyle, "#ffa000")}><h4>Collaboration Style</h4><div className="cultural-fit-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Cultural Fit") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Cultural Fit") ? '100%' : `${applicant.rank_score?.collaborationStyle ? (applicant.rank_score.collaborationStyle * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Cultural Fit") ? '#d9d9d9' : '#ffa000' }}></div></div><p>{!job?.prompt?.includes("Cultural Fit") ? "Unranked" : (applicant.rank_score?.collaborationStyle ? `${applicant.rank_score.collaborationStyle}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Growth Mindset", applicant.rank_score?.growthMindset || 0, applicant.reasoning?.growthMindset, "#ffa000")}><h4>Growth Mindset</h4><div className="cultural-fit-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Cultural Fit") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Cultural Fit") ? '100%' : `${applicant.rank_score?.growthMindset ? (applicant.rank_score.growthMindset * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Cultural Fit") ? '#d9d9d9' : '#ffa000' }}></div></div><p>{!job?.prompt?.includes("Cultural Fit") ? "Unranked" : (applicant.rank_score?.growthMindset ? `${applicant.rank_score.growthMindset}/10` : "0/10")}</p></div>
                                                    <div className="score-card" onClick={() => handleScoreCardClick("Community Engagement", applicant.rank_score?.communityEngagement || 0, applicant.reasoning?.communityEngagement, "#ffa000")}><h4>Community Engagement</h4><div className="cultural-fit-progress-bar-container"><div className={`progress-bar ${!job?.prompt?.includes("Cultural Fit") ? 'unranked' : ''}`} style={{ width: !job?.prompt?.includes("Cultural Fit") ? '100%' : `${applicant.rank_score?.communityEngagement ? (applicant.rank_score.communityEngagement * 10) : 0}%`, backgroundColor: !job?.prompt?.includes("Cultural Fit") ? '#d9d9d9' : '#ffa000' }}></div></div><p>{!job?.prompt?.includes("Cultural Fit") ? "Unranked" : (applicant.rank_score?.communityEngagement ? `${applicant.rank_score.communityEngagement}/10` : "0/10")}</p></div>
                                                </div>
                                            )}
                                        </div>
                                    )}
